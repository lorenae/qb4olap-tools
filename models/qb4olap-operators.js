...
exports.getSimplifiedQuery = function(endpoint, datacube, query, callback){
    ...
    switch(queryType){
                ...
                var stcount = 1;
                    ...
                    //dicesOnAttributes is a list of all dice operations in the query that contain exclusively coditions over levels
                    ...
                    dices.forEach(function(dice){
                        if(dice.dicecondition.operator == 'AND'){
                            var dicemeasurelist = [];
                            var diceattlist = [];
                            splitDiceAnd(dice.dicecondition, dice.statement, dicemeasurelist,diceattlist);
                            dicesOnAttributes = dicesOnAttributes.concat(diceattlist);
                            ...
                            if(existsConditionOverMeasure(dice.dicecondition)){
                                ...
                                dicesOnAttributes.push(dice);
                            }
                        }
                    });

                    console.log('dicesOnAttributes:');
                    console.log(util.inspect(dicesOnAttributes, { showHidden: false, depth: null, colors:true }));
                    ...
                    dicesOnAttributes.forEach(function(dice){
/*
